#ifndef RED_DETECTION_H
#define RED_DETECTION_H
...
Mat1b find_red(Mat3b bgr){
    ...
    //inRange(hsv, Scalar(0, 40, 30), Scalar(10, 255, 255), mask1); //Minimum Redness
    inRange(hsv, Scalar(5, 100, 100), Scalar(8, 255, 255), mask1); //Minimum Redness
    inRange(hsv, Scalar(174, 100, 100), Scalar(179, 255, 255), mask2); //Maximum Redness
